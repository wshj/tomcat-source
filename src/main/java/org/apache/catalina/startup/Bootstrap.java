...
public final class Bootstrap {
    ...
    /**
     * 初始化 classLoaders。thesharedLoader、serverLoader通过 commonLoader 加载
     * <ol>
     *     <li>commonLoader (common)-> System Loader</li>
     *     <li>catalinaLoader(server) -> commonLoader -> System Loader</li>
     *     <li>sharedLoader (shared)-> commonLoader -> System Loader</li>
     * </ol>
     */
     ...
     * Initialize daemon.
     * <ol>
     *     <li>初始化 classLoaders。commonLoader (common)、catalinaLoader(server)、sharedLoader (shared)</li>
     *     <li>当前线程的 contextClassloader 设置为 catalinaLoader</li>
     *     <li>通过反射加载启动类（org.apache.catalina.startup.Catalina）</li>
     *     <li>Catalina.parentClassLoader 设置为 sharedLoader</li>
     *     <li>catalinaDaemon 设置为 Catalina 对象</li>
     * </ol>
     *
